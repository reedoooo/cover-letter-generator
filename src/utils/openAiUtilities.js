...
// });
const openaiGpt3Model = 'gpt-3.5-turbo';
const openaiGpt4Model = 'gpt-4-0613';
...
function createPrompt({ generatorTitle, data }) {
  const generator = promptGenerators[generatorTitle];
  if (!generator) {
    throw new Error(`No generator found for title: ${generatorTitle}`);
  }
